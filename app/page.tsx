  ...
  return (
    <main className="shell">
      <section className="hero">
        <div className="hero-content">
          <div>
            ...
            <p>
              PANCHO DEVNET ARENA is live on Solana. Connect your wallet, pick <strong>BULL</strong> or{" "}
      ...
      <section className="notes">
        <p>
          Devnet live. Entry closes every 60s and settles 5m after lock. Tap Payout Math for simple pool examples.
        </p>
      </section>
    </main>
  );
